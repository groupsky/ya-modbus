...
function main() {
  ...
  console.log(`Running publint on ${packages.length} packages...\n`)
  ...
  if (hasErrors) {
    console.log('\x1b[31mPublint validation failed!\x1b[0m')
    process.exit(1)
  } else {
    console.log('\x1b[32mAll packages passed publint validation.\x1b[0m')
  }
}
